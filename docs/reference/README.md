...
- Looking up an endpoint or its parameters?
- Need to understand a data structure?
- Wondering what a term means in our domain?
- Building an API client or integration?

This section is optimized for **quick lookups** and reference. For guides on how to build features, see [Developer Guides](../guides/README.md).
