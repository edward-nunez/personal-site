        ...
        >
          ...
          <div className="manga-panel-thick bg-card p-8 md:p-12 manga-shadow text-left">
            <div className="flex flex-col items-center mb-8">
              ...
              <p className="font-mono text-sm tracking-widest uppercase text-accent mt-1">Systems Architect · Senior Software Engineer</p>
            </div>
            <p className="text-lg text-card-foreground mb-8 text-center">
              Looking to build resilient systems, talk architecture patterns, 
              or swap notes on the best sport touring routes? 
              I'm always down for a good conversation — digital or trailside.
            </p>
