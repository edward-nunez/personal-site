import { SectionHeading, Card } from '@/design-system/components';
      ...
      <div className="container-wide">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-[2fr_1fr] gap-8">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href="https://github.com/edwardnunez"
                      target="_blank"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href="https://linkedin.com/in/edwardnunez"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-fg-secondary hover:text-accent transition-colors"
                    >
            ...
            <Card>
              <h3 className="text-lg font-semibold text-fg mb-4">Response Time</h3>
              <p className="text-sm text-fg-secondary">
                I typically respond within 24-48 hours. For urgent inquiries, please mention it in
                your message.
              </p>
            </Card>
          </div>
